...
public class SpawnManager : MonoBehaviour
{
    ...
    private void SpawnThing()
    {
        ...
        GameObject thing = selection.Spawn(_spawnPositionManager.GetRandomAvailableSpawnPosition());

        //parent thing to thing's prefab container
        thing.transform.SetParent(thing.GetComponent<EnemySpawnableObject>().GetPrefabContainer());
