...
public class SpawnPositionManager : MonoBehaviour
{
    ...
    {
        PopulateMainPositionListWithChildSpawnPositions();
    ...
    */
    ...
    private void PopulateMainPositionListWithChildSpawnPositions()
    {
        SpawnPosition[] SpawnPositionsReferences = GetComponentsInChildren<SpawnPosition>();

        foreach (SpawnPosition positionReference in SpawnPositionsReferences)
            _allPositions.Add(positionReference);
    }
